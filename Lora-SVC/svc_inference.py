...
def main(args):
    ...
    assert args.ppg is not None and os.path.isfile(args.ppg) and os.path.exists(args.ppg)
    ...
    if (args.statics == None):
        ...
        singer_ave = singer_ave + args.singer_pitch_ave_factor
        print(f"modify {args.singer_pitch_ave_factor}, singer pitch statics: mean={singer_ave:0.1f}, \
                min={singer_min:0.1f}, max={singer_max:0.1f}")
    ...
    write(args.des, hp.audio.sampling_rate, audio)
    write(args.des_pitch, hp.audio.sampling_rate, pitwav)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-des', '--des', type=str,
                        help="Path of pitch statics.")
    parser.add_argument('-des_pitch', '--des_pitch', type=str,
                        help="Path of pitch statics.")
